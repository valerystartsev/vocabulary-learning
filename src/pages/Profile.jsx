...
export default function Profile() {
  ...
  // upsert = обнови запись если она есть, создай если нет.
  ...
  return (
    ...
    >
      ...
      <div className="space-y-5">
        ...
        {/* Блок University Tracking — чекбокс */}
        <div className="rounded-2xl p-5" style={{ backgroundColor: 'var(--col-surface)', border: '1px solid var(--col-border)' }}>
          ...
          {/*
            Чекбокс обёрнут в <label>.
            Клик по любому месту внутри label (текст ИЛИ квадратик)
            активирует скрытый <input> → onChange → один раз меняет состояние.
            Визуальный <div> НЕ имеет своего onClick — это исправление бага.
          */}
